...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/Mark-s-personal-organization/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>Mark-s-personal-organization</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>Mark-s-personal-organization</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/Mark-s-personal-organization/pipeline-template-catalog.git</repositoryUrl>
              <traits>
